...
export default function AboutPage() {
  return (
    <main className="text-gray-800 h-screen w-screen bg-stone-100 py-16 px-4 flex flex-col gap-6 bg-repeat lg:flex-row xl:items-center">      
      <section className="max-w-4xl mx-auto animate-fade-in-up mt-4 lg:order-2">
        <h1 className="text-5xl font-semibold text-center mb-9 mt-5 font-leah text-gray-900">
          Qui je suis
        </h1>
        <article className="flex flex-col xl:flex-row items-center gap-12 mb-12">
          <div className="w-60 h-96 flex justify-center rounded-full shadow-xl  border-4 border overflow-hidden ">
            <Image
          ...
          <div className="w-full lg:w-2/3 space-y-5 text-lg flex flex-col items-center">
            <p>
        ...
        <article className="shadow-md px-8 py-10 mb-10 bg-gray-600 forced-border">          
      ...
      <section className="flex justify-center animate-fade-in-up mt-8 xl:w-1/3">
      ...
      <section className="flex justify-center animate-fade-in-up mt-6 lg:order-3 xl:w-1/3">
        <article className="flex flex-col space-y-4 text-center">          
          <div className="bg-stone-300 p-4 shadow-lg hover:shadow-2xl transition duration-300 hover:-translate-x-4">
            <div className="text-4xl mb-2">🏗️</div>
